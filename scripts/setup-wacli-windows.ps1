...
Write-Host "  6) Edite config/auto-pipeline.json -> targets"
Write-Host "  7) node --env-file=.env.local scripts/auto-pipeline.mjs --dry-run"
Write-Host "  8) Agende no Agendador de Tarefas do Windows (1–2x por dia)"
